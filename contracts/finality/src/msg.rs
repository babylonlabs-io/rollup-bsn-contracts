...
pub enum QueryMsg {
    ...
    /// Get the list of allowed finality providers at a specific height.
    ///
    /// Returns a list of BTC public keys (in hex format) that were allowed
    /// at the specified height or the most recent height before it.
    #[returns(Vec<String>)]
    AllowedFinalityProvidersAtHeight { height: u64 },
}
